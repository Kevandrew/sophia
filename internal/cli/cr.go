...
func newCRCmd() *cobra.Command {
	crCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
			if err := applyAutomaticJSONFlag(cmd); err != nil {
				return err
			}
	...
	crCmd.AddCommand(newCRDelegateCmd())
