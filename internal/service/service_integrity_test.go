...
func TestCurrentSwitchAndReopenCRWorkflow(t *testing.T) {
	...
	runGit(t, dir, "config", "user.name", "Test User")
	runGit(t, dir, "config", "user.email", "test@example.com")
	runGit(t, dir, "add", ".sophia")
	runGit(t, dir, "commit", "-m", "chore: track sophia metadata")
	...
	runGit(t, dir, "add", ".sophia")
	runGit(t, dir, "commit", "-m", "chore: persist cr1 metadata")
	...
	runGit(t, dir, "add", ".sophia/cr/1.yaml")
	runGit(t, dir, "commit", "-m", "chore: persist cr1 merged metadata")
	runGit(t, dir, "branch", "-D", cr1.Branch)
